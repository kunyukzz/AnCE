...
{
    ac_zero_memory_t(out_command_buffer, sizeof(*out_command_buffer));
...
void vulkan_command_buffer_free(vulkan_context* context, VkCommandPool pool, vulkan_command_buffer* command_buffer)
{
    ...
    command_buffer->state = COM_BUFFER_STATE_NOT_ALLOCATED;
}
...
void vulkan_command_buffer_end(vulkan_command_buffer* command_buffer)
{
    ...
    command_buffer->state = COM_BUFFER_STATE_RECORD_END;
}

void vulkan_command_buffer_update_submitted(vulkan_command_buffer* command_buffer)
{
    command_buffer->state = COM_BUFFER_STATE_SUBMITTED;
}

void vulkan_command_buffer_reset(vulkan_command_buffer* command_buffer)
{
    command_buffer->state = COM_BUFFER_STATE_READY;
}

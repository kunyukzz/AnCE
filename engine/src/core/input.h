...
// keyboard input
ACAPI b8 input_key_down(keys key);
ACAPI b8 input_key_up(keys key);
ACAPI b8 input_was_key_down(keys key);
ACAPI b8 input_was_key_down(keys key);

void input_process_key(keys key, b8 pressed);

// mouse input
ACAPI b8 input_mouse_button_down(buttons button);
ACAPI b8 input_mouse_button_up(buttons button);
ACAPI b8 input_mouse_was_button_down(buttons button);
ACAPI b8 input_mouse_was_button_up(buttons button);
ACAPI void input_get_mouse_pos(i32* x, i32* y);
ACAPI void input_get_prev_mouse_pos(i32* x, i32* y);
